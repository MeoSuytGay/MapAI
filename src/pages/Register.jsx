      ...
      <main className="flex-grow flex items-center justify-center pt-12 pb-12 px-4 relative z-10">
        ...
        >
          <div className="text-center mb-6">
            <h1 className="text-2xl font-black text-white mb-1.5 tracking-tight">Yêu cầu cấp quyền</h1>
            <p className="text-slate-500 font-bold text-[11px] uppercase tracking-[0.1em]">Khởi tạo tài khoản hệ thống MapAI</p>
          </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative flex items-center">
                ...
                <span className="mx-4 text-[8px] font-black text-slate-600 uppercase tracking-[0.4em]">MapAI Identity</span>
                <div className="flex-grow border-t border-white/5"></div>
              </div>
              ...
              <div className="space-y-3.5">
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within:text-blue-500 transition-colors w-4 h-4" />
                  <input
                    type="text"
                    required
                    value={name}
              ...
              <div className="px-1">
                <p className="text-[10px] text-slate-500 leading-relaxed">
                  Bằng cách đăng ký, bạn đồng ý với <span className="text-blue-500 font-bold cursor-pointer hover:underline">Điều khoản dịch vụ</span> và <span className="text-blue-500 font-bold cursor-pointer hover:underline">Chính sách bảo mật</span> của MapAI.
                </p>
              </div>
